...
<style>
	...
	<table align="center" border="0" width="100%" cellpadding="0" cellspacing="0" style="margin-left: 10px; margin-right: 280px;">
        <tr class="tt">
            <td width="320px" class="brlf">订单号：
            <a href="<c:url value='/orderServlet?method=load&oid=${order.oid }'/>">${order.oid }</a></td>
        ...
        <tr style="padding-top: 10px; padding-bottom: 10px;">
            ...
            <img border="0" width="70" src="<c:url value='/${orderItem.book.image_b }'/>" /></a>
            </c:forEach>
            </td>                          
        </tr>
    </table>
    
    <span style="margin-left: 10px; margin-right: 280px;">
    	承运来源：
            <c:choose>
                <c:when test="${shipperCode eq 'YD' }">韵达快递</c:when>
                <c:when test="${shipperCode eq 'SF' }">顺丰快递</c:when>
                <c:when test="${shipperCode eq 'YTO' }">圆通快递)</c:when>
            </c:choose>        
     </span>
     
    <br/>
    <span style="margin-left: 10px; margin-right: 280px;">运单编号：${logisticCode }</span>
    		
    <br/>
    <br/>
    <span style="margin-left: 10px; margin-right: 280px;">物流跟踪</span>
            ...
            <div class="mohe-wrap mh-wrap">
                <div class="mh-cont mh-list-wrap mh-unfold">
                    <div class="mh-list">
                        <ul>
                            <li class="first">
                                <p>${logisticsNew.acceptTime}</p>
                                <p>${logisticsNew.acceptStation}</p>
                                <span class="before"></span><span class="after"></span>
                               <i class="mh-icon mh-icon-new"></i>
                            </li> 
                        	<c:forEach items="${logisticsList }" var="logistics">
                            <li>
                                <p>${logistics.acceptTime}</p>
                                <p>${logistics.acceptStation}</p>
                                <span class="before"></span><span class="after"></span>
                            </li>
                            </c:forEach> 
                            
							<a id="confirm" href="javascript:" onclick="self.location=document.referrer;">返回</a>	                   
                        </ul>
                    </div>
                </div>
            </div>
